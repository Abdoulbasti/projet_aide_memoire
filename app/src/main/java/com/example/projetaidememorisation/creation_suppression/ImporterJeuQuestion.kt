...
class ImporterJeuQuestion : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            EcranImporterJeuQuestion()
        }
    }
}

@Composable
fun EcranImporterJeuQuestion() {
    ...
    Column (
        ...
        titreActivite("Importer Jeu de question", Color(0xFFCC99CC))
